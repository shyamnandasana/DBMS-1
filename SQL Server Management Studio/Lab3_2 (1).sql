...
UPDATE DEPOSITE SET BNAME = 'ANDHERI WEST' WHERE BNAME = 'ANDHERI'
...
UPDATE BORROW SET AMOUNT = (AMOUNT + (AMOUNT * 0.1)) WHERE 1 = 1

--2. Customer deposits additional 20% amount to their account, update the same. (Use Deposit Table)
UPDATE DEPOSITE SET AMOUNT = (AMOUNT + (AMOUNT * 0.2)) WHERE 1 = 1
